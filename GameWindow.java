    ...
    public GameWindow() {
     ...
     this.addKeyListener(new java.awt.event.KeyAdapter() {
        @Override   
            ...
            JDialog pauseDialog = new javax.swing.JDialog(GameWindow.this, "Paused", true);
            pauseDialog.setSize(400, 350);
            pauseDialog.setLayout(new java.awt.GridLayout(3, 1, 10, 10));
            pauseDialog.setLocationRelativeTo(GameWindow.this);

            JLabel label = new javax.swing.JLabel("Game Paused", javax.swing.SwingConstants.CENTER);
