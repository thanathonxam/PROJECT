...
public class GameWindow extends JFrame {
    ...
    public GameWindow() {
        ...
        pause.setForeground(new Color(200,200,200));
        pause.setBounds(  24, 700, 252, 36);
        sidePanel.add(pause);

        pause.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
               boolean success = SaveBoard.save(ChessBoard, GameClock, "File/savegame.dat");
            if(success) JOptionPane.showMessageDialog(null, "Game saved!");
            else JOptionPane.showMessageDialog(null, "Failed to save.", "Error", JOptionPane.ERROR_MESSAGE);
