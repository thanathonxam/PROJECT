        ...
        @Override   
            public void keyPressed(java.awt.event.KeyEvent e) {
                if (e.getKeyCode() == java.awt.event.KeyEvent.VK_ESCAPE) {
                    ...
                    resumeBtn.setFont(new Font("Arial", Font.BOLD, 30)); // ฟอนต์ที่ใหญ่ขึ้นและตัวหนา
                    resumeBtn.setBackground(new Color(46, 204, 113));
                    resumeBtn.setPreferredSize(new Dimension(250, 60)); // กำหนดขนาดปุ่ม
                    resumeBtn.setBorder(BorderFactory.createRaisedBevelBorder()); // ขอบนูน
                    resumeBtn.setForeground(Color.WHITE);

                    JButton DrawBtn = new javax.swing.JButton("Draw Game");
                    DrawBtn.setFont(new Font("Arial", Font.BOLD, 30)); // ฟอนต์ที่ใหญ่ขึ้นและตัวหนา
                    DrawBtn.setBackground(new Color(30, 144, 255));
                    DrawBtn.setPreferredSize(new Dimension(250, 60)); // กำหนดขนาดปุ่ม
                    DrawBtn.setBorder(BorderFactory.createRaisedBevelBorder()); // ขอบนูน
                    DrawBtn.setForeground(Color.WHITE);

                    JButton exitBtn = new javax.swing.JButton("Exit Game");
                    exitBtn.setFont(new Font("Arial", Font.BOLD, 30)); // ฟอนต์ที่ใหญ่ขึ้นและตัวหนา
                    exitBtn.setBackground(new Color(255, 69, 0));
                    exitBtn.setPreferredSize(new Dimension(250, 60)); // กำหนดขนาดปุ่ม
                    exitBtn.setBorder(BorderFactory.createRaisedBevelBorder()); // ขอบนูน
                    ...
                    public void actionPerformed(ActionEvent ev) {
                        pauseDialog.dispose(); // ปิดหน้าต่าง pause
                        GameWindow.this.requestFocusInWindow(); // เอา focus กลับมา
                    }
                    });
